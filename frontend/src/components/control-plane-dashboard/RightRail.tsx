...
const RiskPolicyCard = ({ model }: RightRailProps) => {
  ...
  return (
    <section className="rounded-xl border border-[#2b3139] bg-[#181a20] p-4">
      <h3 className="text-base font-bold text-white">{t("Risk Policy")}</h3>
      <div className="mt-3 grid grid-cols-2 gap-3">
        {[
          ...
          [
            "Order",
            formatCurrency(model.status.defaultPolicy.maxOrderNotional),
          ],
  ...
  return (
    <section className="rounded-xl border border-[#2b3139] bg-[#181a20] p-4">
      <div className="flex items-center justify-between gap-3">
        <h3 className="text-base font-bold text-white">{t("Latest Risk")}</h3>
        {evaluation ? (
          <span
...
const SafetyGatesCard = () => {
  ...
  return (
    <section className="rounded-xl border border-[#2b3139] bg-[#181a20] p-4">
      <h3 className="text-base font-bold text-white">{t("Safety Gates")}</h3>
  ...
  return (
    <section className="rounded-xl border border-[#2b3139] bg-[#181a20] p-4">
      <h3 className="text-base font-bold text-white">
        {t("Autonomous Investing Lifecycle")}
      </h3>
      <div className="mt-3 space-y-2">
