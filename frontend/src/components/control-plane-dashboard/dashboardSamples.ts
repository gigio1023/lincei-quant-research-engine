...
export const DOCUMENTED_AUTONOMOUS_RUN_SCHEDULES: AutonomousRunSchedule[] = [
  {
    ...
    researchDatasetId: "docs-sample-monthly-bars",
    researchSymbol: "005930",
    researchBenchmark: "KOSPI200",
    researchMaxDataAgeMinutes: null,
...
export const DOCUMENTED_PAPER_ORDER_PLANS: PaperOrderPlan[] = [
  {
    ...
    readinessSnapshot: {
      ...
      approvalPaperAccountEventHash: "sha256:docs-account-event",
      currentPaperAccountEventHash: "sha256:docs-account-event",
    ...
    reservationHold: {
      ...
      paperAccountEventHashAtHold: "sha256:docs-account-event",
...
export const DOCUMENTED_ORDER_PLAN_APPROVALS: OrderPlanApproval[] = [
  {
    ...
    proposalHash: "sha256:docs-proposal",
    riskRequestHash: "sha256:docs-risk",
    paperAccountId: "paper-account-docs",
    paperAccountEventHash: "sha256:docs-account-event",
    paperAccountEventSequence: 2,
    custodyMode: "local_hash_signature",
    signerKeyRef: "local-paper-approval-key-v1",
    canonicalPayloadHash: "sha256:docs-canonical-payload",
    signature: "local-sha256:docs-signature",
...
export const DOCUMENTED_FUNDING_READINESS: FundingReadinessRecord[] = [
  {
    id: "funding-docs-001",
    provider: "manual",
    idempotencyKey: "funding-docs-001",
    brokerSnapshotId: "broker-snapshot-docs-001",
    accountRefHash: "sha256:docs-account-ref",
    currency: "KRW",
    expectedDepositAmount: 9_499_500,
    actualBrokerCash: 9_499_500,
    actualBrokerEquity: 9_999_850,
...
export const DOCUMENTED_LIVE_PILOT_READINESS: LivePilotReadinessRecord[] = [
  {
    id: "live-pilot-docs-001",
    idempotencyKey: "live-pilot-docs-001",
    fundingReadinessId: "funding-docs-001",
    currency: "KRW",
...
export const DOCUMENTED_BROKER_ORDER_COMMANDS: BrokerOrderCommand[] = [
  {
    id: "broker-command-docs-001",
    idempotencyKey: "broker-command-docs-001",
    provider: "toss",
    commandType: "submit_order_plan",
    status: "blocked",
    mode: "dry_run",
    sourceType: "paper_order_plan",
    proposalId: "proposal-docs-001",
    paperOrderPlanId: "paper-docs-plan-001",
    orderPlanApprovalId: "approval-docs-001",
    livePilotReadinessId: "live-pilot-docs-001",
    checkedAt: "2026-05-22T09:10:00.000Z",
    commandHash: "sha256:docs-broker-command",
    readinessSnapshot: {
      livePilotReadinessId: "live-pilot-docs-001",
    ...
    orderIntents: [
      {
        brokerOrderIntentId: "broker-intent:docs:0",
        sourcePaperOrderId: "paper-docs-order-001",
        proposalOrderIndex: 0,
        symbol: "005930",
        side: "BUY",
        orderType: "MARKET",
...
export const DOCUMENTED_BROKER_ORDER_STATUSES: BrokerOrderStatusRecord[] = [
  {
    id: "broker-order-status-docs-001",
    provider: "manual",
    sourceRef: "documented-read-only-order-status-import",
    accountRefHash: "sha256:docs-account-ref",
    brokerOrderRefHash: "sha256:docs-broker-order-open",
    brokerOrderCommandId: "broker-command-docs-001",
    brokerOrderIntentId: "broker-intent:docs:0",
    paperOrderPlanId: "paper-docs-plan-001",
    status: "mismatch",
    externalStatus: "open",
    ...
    side: "BUY",
    orderType: "MARKET",
    requestedQuantity: 6.8,
    filledQuantity: 0,
    remainingQuantity: 6.8,
    requestedNotional: 499_800,
    currency: "KRW",
    ...
    reconciliation: {
      ...
      expectedNotional: 499_800,
      expectedQuantity: 6.8,
      notionalDiff: 0,
      quantityDiff: 0,
      notes: [
        "Broker order shape matches the dry-run command, but the command was dry-run only. Treat external open order evidence as a mismatch until a real broker write path exists.",
      ],
    },
    notes: [
      "Documented broker order status sample is read-only lifecycle evidence.",
    ],
    brokerExecutionEnabled: false,
    liveTradingEnabled: false,
...
export const DOCUMENTED_BROKER_FILLS: BrokerFill[] = [
  {
    ...
    reconciliation: {
      ...
      checkedAt: "2026-05-22T09:08:00.000Z",
      paperOrderPlanId: "paper-docs-plan-001",
      paperFillId: "paper-docs-order-001:fill:0",
      symbolMatched: true,
      sideMatched: true,
