...
- **Background Processes**: Always run long-running processes like development servers (e.g., `npm run dev`, `vite`) in the background using the `&` operator to avoid blocking further execution. For example: `npm run dev &`.
